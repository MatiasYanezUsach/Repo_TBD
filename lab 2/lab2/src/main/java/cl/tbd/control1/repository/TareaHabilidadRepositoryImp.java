...
public class TareaHabilidadRepositoryImp implements TareaHabilidadRepository{
    ...
    public TareaHabilidad createTarea_Habilidad(TareaHabilidad tarea_Habilidad){
        ...
        String SQL_INSERT = "INSERT INTO tarea_habilidad(id, id_tarea, id_eme_habilidad)" + 
    ...
    public void updateTarea_Habilidad(TareaHabilidad tarea_Habilidad,int id){
        ...
        String SQL_UPDATE = "UPDATE tarea_habilidad SET id_tarea = :id_tarea,id_eme_habilidad= :id_eme_habilidad, id = :id WHERE id = :id";
        try(Connection conn = sql2o.open()) {
    ...
    public List<TareaHabilidad> getAllByTarea(int id){
        try (Connection conn = sql2o.open()){
            return conn.createQuery("SELECT * FROM tarea_habilidad WHERE id_tarea=:id")
            .addParameter("id", id)
